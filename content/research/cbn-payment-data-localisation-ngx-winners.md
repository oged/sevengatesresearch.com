...
draft: false
legacyImported: true
legacyUrl: "https://www.sevengatesresearch.com/research/cbn-payment-data-localisation-ngx-winners"
slug: "cbn-payment-data-localisation-ngx-winners"
date: "2026-08-25"
title: "The Data Must Come Home. The Profits May Not."
excerpt: "CBN payment-data localisation: valuations, moats and risks for MTN Nigeria, CWG, Airtel Africa, eTranzact and Chams."
readingTime: "24 min"
...
The Central Bank of Nigeria’s June circular is consequential. From 1 January 2027, financial institutions and payment participants must ensure that payment-transaction data generated in Nigeria is stored and managed in Nigeria.[1](#fn1) The same circular also tightens beneficial-ownership disclosure, market-concentration limits and systemic oversight. It will bring work to Nigerian data centres, connectivity providers, cloud platforms, cyber-security firms and systems integrators. Some revenue will be recurring. Some will be the one-off wages of migration. Some firms will merely pay the bill.
...
The circular, dated 15 June 2026, has four relevant parts.[2](#fn2)
...
Nigeria’s payment volumes are large and rising. KPMG cites 11.2 billion NIBSS Instant Payment transactions in 2024, with transaction volumes up 120 per cent between 2022 and 2024. Records may need to be retained for at least five years. KPMG also identifies practical deficiencies in compute, storage, security, disaster recovery, network redundancy, power, cooling, operations and specialist skills.[5](#fn5) Foreign-backed fintechs and offshore-first businesses have barely four and a half months from this article’s date to redesign critical systems. Capacity cannot be summoned by circular.
...
The directive does not begin from zero. Rack Centre says CBN has required banks since 2015 to maintain at least one data centre in a Tier III-certified facility and that most banks already hold primary or secondary storage in such facilities.[6](#fn6) Uptime Institute’s Nigerian certification register includes facilities operated for or by GTBank, Galaxy Backbone, MainOne, MTN, OADC and Rack Centre, among others.[7](#fn7)
...
Nigeria’s data-centre market is undeniably growing. One industry estimate puts revenue at about $323 million in 2025 and $374 million in 2026, reaching $783 million by 2031.[8](#fn8) Such estimates vary widely by what they count. They are useful as a compass, not a cadastral survey.
...
At ₦779, MTN Nigeria is worth roughly ₦16.36 trillion. Its trailing earnings of about ₦67 a share put the stock on 11.6 times earnings.[10](#fn10) In a market where nominal growth can flatter everything and the risk-free rate is not shy, that is not bargain-basement. It is reasonable for a company whose balance sheet, margins and cash generation have been repaired.
...
In H1 2026, the “other” line containing cloud, infrastructure and ICT services produced about ₦23.9 billion, less than 1 per cent of group revenue. Enterprise revenue did not show the inflection that a localisation boom would require.[13](#fn13) Even the whole $240 million facility is a small asset beside a ₦16.36 trillion equity value. A spectacular ramp can be operationally important and still barely disturb near-term earnings per share.
...
CWG is the most intellectually defensible small-cap beneficiary. It provides IT infrastructure, software, platform services, systems integration, managed services and colocation. It has longstanding banking relationships and Finacle expertise. When a financial institution must map data, buy hardware, redesign architecture, migrate databases, test disaster recovery and document compliance, CWG can plausibly appear on several invoices.[14](#fn14)
...
FY2025 revenue rose to ₦65.55 billion. Gross profit was ₦15.94 billion, profit before tax ₦7.87 billion and profit after tax ₦4.97 billion, equivalent to EPS of ₦1.97.[15](#fn15) At ₦21.40, the market capitalisation is about ₦54 billion and the stock trades at roughly 10 to 11 times recent earnings. On the face of it, that is sensible.

The face is not the whole person.

CWG’s mix is weighted towards infrastructure and software supply, where vendor costs and imported equipment can dominate revenue. Its own colocation offer is real, but the company does not publish MW, rack count, certification, occupancy, average contract life, segment revenue or return on invested capital for the facility. Uptime Institute’s public Nigerian list does not identify a CWG-certified commercial facility.[16](#fn16) That does not prove the facility is poor; it proves the investor lacks evidence for treating CWG as a scaled data-centre landlord.

### Profit arrived before cash

FY2025 operating cash flow was negative by about ₦2.17 billion. Contract assets rose to roughly ₦11.6 billion, an increase of more than six times, while inventories and receivables also absorbed capital.[17](#fn17) By Q1 2026, inventories were about ₦11.7 billion, receivables ₦27.2 billion and cash ₦3.7 billion.[18](#fn18)
...
Airtel Africa belongs on the list even though it is often omitted. Its Nxtra unit is building a 38MW hyperscale facility at Eko Atlantic and aspires to a broader African data-centre network.[19](#fn19) If completed, energised and leased, that is far more capacity than MTN’s disclosed Lagos project.
...
At about £3.36 in London, the shares trade around 24 times trailing earnings but roughly 12.3 times forward consensus earnings after a powerful rerating.[20](#fn20) That is not absurd if delivery is excellent. It is not a fresh policy bargain. We would become interested around **£2.70 to £2.90**, where execution risk is better paid.
...
The instinct to exclude eTranzact from the data-centre beneficiaries is correct. CBN’s own register identifies eTranzact as a mobile-money operator and switching/processing participant.[21](#fn21) It moves payments. It does not own a disclosed commercial data-centre platform of consequence.
...
FY2025 revenue was ₦30.61 billion and profit after tax ₦2.47 billion, with EPS around ₦0.27.[22](#fn22) H1 2026 revenue rose 23 per cent to ₦16.28 billion, but cost of sales grew 39 per cent and profit after tax fell 19 per cent to ₦1.22 billion.[23](#fn23)
...
Chams is frequently put into the basket because it has technology, payments and now ChamsCorp, a subsidiary launched in February 2026 to pursue AI, cloud and data-centre opportunities through partnerships.[24](#fn24) The language is ambitious. The capacity is not disclosed.
...
FY2025 revenue rose 18 per cent to ₦17.50 billion and profit after tax increased 55 per cent to about ₦606 million.[25](#fn25) The group also raised fresh equity, taking the share count to 9 billion and strengthening liquidity.

H1 2026 revenue grew only 2.5 per cent to ₦10.34 billion. Gross profit improved 31 per cent, but administrative costs rose 71 per cent and operating profit fell 44 per cent to ₦529 million. Finance income of ₦539 million, against ₦18 million a year earlier, helped profit after tax rise 13 per cent to ₦473 million.[26](#fn26)
...
**Equinix/MainOne/MDXi.** Equinix owns MainOne and operates Lagos facilities with an interconnection ecosystem that is difficult to reproduce quickly.[27](#fn27) The moat is not concrete. It is the dense community of carriers, banks, clouds and enterprises connected inside the building. Each additional participant makes the site more useful to the others. That is a genuine network effect. Nigeria is still too small to make the CBN circular a primary reason to buy global Equinix shares.

**Digital Realty/Medallion.** Digital Realty operates several Lagos facilities through Medallion and has added capacity.[28](#fn28) It brings global customers, design standards, capital and carrier-neutral positioning. Again, a Nigerian demand bump is desirable and immaterial to the valuation of the global REIT.

**Rack Centre.** The Actis/Jagal-backed operator has certified capacity, industry relationships and expansion plans.[29](#fn29) It is a plausible direct beneficiary and privately held.

**OADC.** Open Access Data Centres markets a 24MW Lagos site load with Tier III design, PCI-DSS and ISO credentials.[30](#fn30) It has the right product for regulated workloads and is private.
...
For scale, we translate Nigerian market values at approximately ₦1,347/$, ₦1,572/€ and ₦1,836/£, using 24 August official and market cross-rates.[31](#fn31) These are indicative, not trading conversions.
...
Airtel Africa’s primary London quotation implies a market value around £11.8 billion, with cross-listing and timing differences explaining why a mechanical conversion of the NGX line can differ.[32](#fn32)
...
1.  Central Bank of Nigeria, [Circular on market structure requirements, data localisation, beneficial ownership and systemic oversight](https://www.cbn.gov.ng/Out/2026/CCD/CIRCULAR%20ON%20INTRODUCTION%20OF%20MARKET%20STRUCTURE%20REQUIREMENTS,%20DATA%20LOCALISATION,%20ULTIMATE%20BENEFICIAL%20OWNERSHIP%20DISCLOSURE,%20AND%20SYSTEMIC%20OVERSIGHT%20MEASURES%20IN%20THE%20NIGERIA%20PAYMENTS%20SYSTEM.pdf), 15 June 2026.[↩︎](#fnref1)
    
2.  Central Bank of Nigeria, [Circular on market structure requirements, data localisation, beneficial ownership and systemic oversight](https://www.cbn.gov.ng/Out/2026/CCD/CIRCULAR%20ON%20INTRODUCTION%20OF%20MARKET%20STRUCTURE%20REQUIREMENTS,%20DATA%20LOCALISATION,%20ULTIMATE%20BENEFICIAL%20OWNERSHIP%20DISCLOSURE,%20AND%20SYSTEMIC%20OVERSIGHT%20MEASURES%20IN%20THE%20NIGERIA%20PAYMENTS%20SYSTEM.pdf), 15 June 2026.[↩︎](#fnref2)
    
3.  Nigeria Data Protection Commission, [General Application and Implementation Directive 2025](https://ndpc.gov.ng/wp-content/uploads/2025/07/NDP-ACT-GAID-2025-MARCH-20TH.pdf).[↩︎](#fnref3)
    
4.  Privalex Advisory, [The CBN Payment Data Localisation Directive: legal tensions, market consequences and the road to 1 January 2027](https://www.privalexadvisory.com/insights/the-cbn-payment-data-localisation-directive-legal-tensions-market-consequences-and-the-road-to-1-january-2027).[↩︎](#fnref4)
    
5.  KPMG Nigeria, [CBN’s Data Localisation Directive](https://assets.kpmg.com/content/dam/kpmgsites/ng/pdf/2026/08/CBN%E2%80%99s%20Data%20Localisation%20Directive.pdf.coredownload.inline.pdf), August 2026.[↩︎](#fnref5)
    
6.  Rack Centre, [Meeting the rising data-centre demand in Africa](https://rack-centre.com/meeting-the-rising-data-centre-demand-in-africa/). The 2015 requirement is the operator’s description and should be read as industry evidence, not our independent legal verification.[↩︎](#fnref6)
    
7.  Uptime Institute, [Nigeria awards and certifications register](https://uptimeinstitute.com/uptime-institute-awards/country/id/NG).[↩︎](#fnref7)
    
8.  Mordor Intelligence, [Nigeria Data Center Market](https://www.mordorintelligence.com/industry-reports/nigeria-data-center-market). Market-research estimates differ by scope and methodology.[↩︎](#fnref8)
    
9.  Amazon Web Services, [AWS Local Zones locations](https://aws.amazon.com/about-aws/global-infrastructure/localzones/locations/).[↩︎](#fnref9)
    
10.  NGX, [MTN Nigeria company profile](https://ngxgroup.com/exchange/data/company-profile/?directory=companydirectory&symbol=MTNN&tdate=2024-03-22T00%3A00%3A00); Financial Times, [MTNN summary and trailing EPS](https://markets.ft.com/data/equities/tearsheet/summary?s=MTNN%3ALAG).[↩︎](#fnref10)
    
11.  MTN Nigeria, [H1 2026 earnings release](https://www.mtn.ng/wp-content/uploads/2026/07/MTN-Nigeria-H1-2026-Earnings-Release.pdf).[↩︎](#fnref11)
    
12.  MTN Nigeria, [Dabengwa Data Centre investment announcement](https://www.mtn.ng/business/newsbusiness/technology-firm-mtn-has-committed-over-240-million-to-construct-a-new-data-centre-in-nigeria/).[↩︎](#fnref12)
    
13.  Techpoint Africa, [MTN Nigeria’s enterprise revenue and cloud/infrastructure disclosure](https://techpoint.africa/news/mtn-enterprise-revenue-falls/), 21 August 2026. Segment descriptions differ slightly from the headline enterprise channel in MTN’s release; we use the disclosure only to establish scale.[↩︎](#fnref13)
    
14.  CWG, [Colocation](https://cwg-plc.com/services/colocation) and [IT infrastructure services](https://cwg-plc.com/services/it-infrastructure).[↩︎](#fnref14)
    
15.  CWG, [Investor relations and FY2025 results](https://cwg-plc.com/investor-relations); NGX Pulse, [CWG market data](https://ngxpulse.ng/stocks/CWG).[↩︎](#fnref15)
    
16.  Uptime Institute, [Nigeria awards and certifications register](https://uptimeinstitute.com/uptime-institute-awards/country/id/NG).[↩︎](#fnref16)
    
17.  Technext, [CWG’s ₦65.6bn revenue and negative operating cash flow](https://technext24.com/news/cwg-%E2%82%A665-6bn-revenue-2025-operating-cash/).[↩︎](#fnref17)
    
18.  Simply Wall St community analysis based on CWG’s Q1 filing, [Q1 2026 working-capital figures](https://simplywall.st/community/narratives/ng/software/ngse-cwg/cwg-shares/7w7l63ez-cwg-plc-reports-resilient-q1-2026-earnings-growth-amid-strong-revenue-expansion-and-working-capital-pressures). Secondary source; figures should be reconciled to the exchange filing before trading.[↩︎](#fnref18)
    
19.  Airtel Africa, [Nxtra data centres](https://www.airtel.africa/data-centers).[↩︎](#fnref19)
    
20.  Yahoo Finance, [Airtel Africa valuation statistics](https://finance.yahoo.com/quote/AAF.L/); NGX Pulse, [Airtel Africa market data](https://ngxpulse.ng/stocks/AIRTELAFRI).[↩︎](#fnref20)
    
21.  Central Bank of Nigeria, [Licensed payment service providers](https://www.cbn.gov.ng/PaymentsSystem/PSPs.html).[↩︎](#fnref21)
    
22.  AfricanFinancials, [eTranzact 2025 annual report](https://africanfinancials.com/document/ng-etranz-2025-ar-00/); NGX Pulse, [eTranzact market data](https://ngxpulse.ng/stocks/ETRANZACT).[↩︎](#fnref22)
    
23.  BusinessDay, [eTranzact H1 2026 profit falls 19 per cent](https://businessday.ng/companies/article/etranzact-half-year-profit-falls-19-as-costs-outpace-revenue-growth/).[↩︎](#fnref23)
    
24.  ChamsCorp, [Corporate site](https://chamscorp.com/); TechCabal, [Chams expands beyond payments with AI and data-centre play](https://techcabal.com/2026/02/17/chams-expands-beyond-payments-with-ai-and-data-centre-play/).[↩︎](#fnref24)
    
25.  AfricanFinancials, [Chams HoldCo 2025 annual report](https://africanfinancials.com/document/ng-chams-2025-ar-00/); NGX Pulse, [Chams market data](https://ngxpulse.ng/stocks/CHAMS).[↩︎](#fnref25)
    
26.  Chams HoldCo, [H1 2026 performance release](https://www.chamsholdco.com/post/chams-holding-company-plc-reports-resilient-h1-2026-performance-as-profit-after-tax-grows-13).[↩︎](#fnref26)
    
27.  Equinix, [Lagos data centres](https://www.equinix.com/data-centers/europe-colocation/nigeria-colocation/lagos-data-centers).[↩︎](#fnref27)
    
28.  Digital Realty, [Lagos data centres](https://www.digitalrealty.com/data-centers/emea/lagos); Data Center Dynamics, [Digital Realty launches additional 2MW facility](https://www.datacenterdynamics.com/en/news/digital-realty-launches-a-2mw-data-center-in-nigeria/).[↩︎](#fnref28)
    
29.  Actis, [Rack Centre portfolio](https://www.act.is/about-us/portfolio/rack-centre/).[↩︎](#fnref29)
    
30.  OADC, [Lagos facility](https://www.openaccessdc.net/lagos).[↩︎](#fnref30)
