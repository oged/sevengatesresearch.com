...
<div class="sgr-eq" style="margin:1.6em 0;padding:1em 1.25em;background:var(--bg-sunken);border-left:3px solid var(--accent);text-align:center;overflow-x:auto;white-space:nowrap;font-size:1.02em">Hormuz closes → oil / freight / insurance ↑ → inflation ↑</div>

So why not add Hormuz directly to the Taylor rule?

Because the same shock may simultaneously do this:

<div class="sgr-eq" style="margin:1.6em 0;padding:1em 1.25em;background:var(--bg-sunken);border-left:3px solid var(--accent);text-align:center;overflow-x:auto;white-space:nowrap;font-size:1.02em">energy costs ↑ → real income ↓ → production ↓ → output gap ↓</div>
...
<div class="sgr-eq" style="margin:1.6em 0;padding:1em 1.25em;background:var(--bg-sunken);border-left:3px solid var(--accent);text-align:center;overflow-x:auto;font-size:1.02em;line-height:1.7">observed financing rate = <i>r</i>* + inflation compensation + FX/country risk + liquidity premium + geopolitical premium</div>
...
<div class="sgr-eq" style="margin:1.6em 0;padding:1em 1.25em;background:var(--bg-sunken);border-left:3px solid var(--accent);text-align:center;overflow-x:auto;white-space:nowrap;font-size:1.08em"><i>i<sub>t</sub></i> = <i>r</i>*<sub><i>t</i></sub> + <i>π<sub>t</sub></i> + <i>α</i>(<i>π<sub>t</sub></i> − <i>π</i>*<sub><i>t</i></sub>) + <i>β</i> <i>ỹ<sub>t</sub></i></div>
...
<div class="sgr-eq" style="margin:1.6em 0;padding:1em 1.25em;background:var(--bg-sunken);border-left:3px solid var(--accent);text-align:center;overflow-x:auto;white-space:nowrap;font-size:1.08em"><i>i</i> = 19.335 + <i>r</i>* + 0.5 <i>ỹ</i></div>
...
<div class="sgr-eq" style="margin:1.6em 0;padding:1em 1.25em;background:var(--bg-sunken);border-left:3px solid var(--accent);text-align:center;overflow-x:auto;white-space:nowrap;font-size:1.08em"><i>ỹ<sub>t</sub></i> = 100 × (<i>Y<sub>t</sub></i> − <i>Y</i>*<sub><i>t</i></sub>) / <i>Y</i>*<sub><i>t</i></sub></div>
...
<div class="sgr-eq" style="margin:1.6em 0;padding:1em 1.25em;background:var(--bg-sunken);border-left:3px solid var(--accent);text-align:center;overflow-x:auto;white-space:nowrap;font-size:1.08em">Δ<i>b</i>*<sub><i>t</i></sub> = Δ<i>x</i>* − <span style="text-decoration:overline">Δ<i>v</i></span><sub><i>t</i></sub> + <i>λ</i>(<i>x</i>*<sub><i>t</i>−1</sub> − <i>x</i><sub><i>t</i>−1</sub>)</div>
...
<div class="sgr-eq" style="margin:1.6em 0;padding:1em 1.25em;background:var(--bg-sunken);border-left:3px solid var(--accent);text-align:center;overflow-x:auto;white-space:nowrap;font-size:1.08em">MD<sub><i>t</i></sub> = Δ<i>b<sub>t</sub></i> − Δ<i>b<sub>t</sub></i><sup>McCallum</sup></div>
...
<div class="sgr-eq" style="margin:1.6em 0;padding:1em 1.25em;background:var(--bg-sunken);border-left:3px solid var(--accent);text-align:center;overflow-x:auto;white-space:nowrap;font-size:1.08em">MD = 12.15 − 8.00 = +4.15 percentage points</div>
...
<div class="sgr-eq" style="margin:1.6em 0;padding:1em 1.25em;background:var(--bg-sunken);border-left:3px solid var(--accent);text-align:center;overflow-x:auto;white-space:nowrap;font-size:1.08em">TD<sub><i>t</i></sub> = <i>i<sub>t</sub></i> − <i>i<sub>t</sub></i><sup>Taylor</sup></div>
...
<div class="sgr-eq" style="margin:1.6em 0;padding:1em 1.25em;background:var(--bg-sunken);border-left:3px solid var(--accent);text-align:center;overflow-x:auto;white-space:nowrap;font-size:1.08em;line-height:2">RT<sub><i>t</i></sub> = (TD<sub><i>t</i></sub> − mean(TD)) / <i>σ</i><sub>TD</sub><br>QT<sub><i>t</i></sub> = −(MD<sub><i>t</i></sub> − mean(MD)) / <i>σ</i><sub>MD</sub><br>RQD<sub><i>t</i></sub> = RT<sub><i>t</i></sub> − QT<sub><i>t</i></sub></div>
...
<div class="sgr-eq" style="margin:1.6em 0;padding:1em 1.25em;background:var(--bg-sunken);border-left:3px solid var(--accent);text-align:center;overflow-x:auto;white-space:nowrap;font-size:1.08em">RQD<sub><i>t</i></sub> → { <i>π</i><sub><i>t</i>+<i>h</i></sub>, Δ<i>e</i><sub><i>t</i>+<i>h</i></sub>, NGDP<sub><i>t</i>+<i>h</i></sub>, Credit<sub><i>t</i>+<i>h</i></sub> }</div>
