...
<figure class="article-chart"><div class="article-table-title"><h2>The company is larger. The shareholder is not yet richer.</h2><p>H1 2026 versus H1 2025.</p></div><div class="research-table valuation-table"><div class="research-table-row research-table-head"><span>Measure</span><span>2026</span><span>2025</span><span>Change</span></div><div class="research-table-row"><strong>Revenue</strong><span>₦35.73bn</span><span>₦15.93bn</span><span>+124%</span></div><div class="research-table-row"><strong>Gross profit</strong><span>₦13.14bn</span><span>₦8.25bn</span><span>+59%</span></div><div class="research-table-row"><strong>Operating profit</strong><span>₦6.17bn</span><span>₦3.86bn</span><span>+60%</span></div><div class="research-table-row"><strong>Finance costs</strong><span>₦4.91bn</span><span>₦0.54bn</span><span>+804%</span></div><div class="research-table-row"><strong>Profit before tax</strong><span>₦2.28bn</span><span>₦3.46bn</span><span>−34%</span></div><div class="research-table-row"><strong>Attributable PAT</strong><span>₦1.84bn</span><span>₦2.29bn</span><span>−20%</span></div><div class="research-table-row"><strong>EPS</strong><span>16 kobo</span><span>26 kobo</span><span>−38%</span></div></div></figure>
...
1.  **Bullet must keep growing**After the flattering acquisition-driven comparisons disappear.
2.  **Cash flow must become debt reduction**Bringing finance costs down with it.
3.  **Profit must outrun the enlarged share count**Revenue growth is not enough. Diluted earnings per share must rise.
